...
<div class="jumbotron card card-image"
    ...
    <div class="text-black text-center py-5 px-4">
        <div>
            <h1 class="card-title h1-responsive pt-3 mb-5 font-bold"><strong>Managers management page</strong></h1>
        </div>
    </div>
</div>
    ...
    <div class="collapse" id="collapse1">
        <div class="form-group mt-3">
            <form action="/managersUpdate" method="post">
                ...
                <div class="form-group">
                    <input type="text" class="form-control" name="salary" placeholder="Изменить зарплату менеджера..."/>
                </div>
                <div class="form-group">
    ...
    <div class="collapse" id="collapse2">
        <div class="form-group mt-3">
            <form action="/managers" method="post">
                ...
                <div class="form-group">
                    <input type="text" class="form-control" name="salary" placeholder="Введите зарплату менеджера..."/>
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" name="hireDate"
